  ...
  useEffect(() => {
    ...
    if (searchQuery.length >= 2) {
      ...
      searchTimeoutRef.current = setTimeout(async () => {
        try {
          const results = await videoService.searchVideos(searchQuery, 5);
            ...
            <div className="hidden md:block" ref={searchRef}>
              <div className="relative">
                ...
                {isSearchOpen && searchQuery.length >= 2 && (
                  <div className="absolute top-full left-0 mt-2 w-96 bg-gray-800 rounded-xl shadow-2xl border border-gray-700 overflow-hidden z-50">
                    {isSearching ? (
                      <div className="p-4 text-center text-gray-400">
                        <div className="w-6 h-6 border-2 border-gray-600 border-t-primary rounded-full animate-spin mx-auto"></div>
                      </div>
                      ...
                      <div className="py-2">
                        {searchResults.map((video) => (
                          <button
                            ...
                            className="w-full flex items-center px-4 py-2 hover:bg-gray-700 transition-colors duration-150 text-left"
                          >
                            {video.thumbnail_url ? (
                              <img
                              ...
                              <div className="w-16 h-9 bg-gray-700 rounded mr-3 flex-shrink-0 flex items-center justify-center">
